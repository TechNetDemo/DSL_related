            ...
            steps{
                script{
                    try{
                        ...
                        build job: '/A.B/SAT/A.B_SAT_WebApp.Pipeline', parameters: [string(name: 'artifact_version', value: artifact_version),string(name: 'db_username', value: db_username),password(name: 'db_password', value: db_password)]
