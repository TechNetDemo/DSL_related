    ...
    stages{
        stage('Download'){
            steps{
                script{
                    myList =[]
                    job1 = build job: '/FO.CSA/JOB/WebApp.DownloadArtifact', propagate: false, parameters: [string(name: 'artifact_version', value: artifact_version)]
                ...
                script{
                    ...
                    for(int j=0; j<agentCount; j++){
                        ...
                        tasks["Task ${nodeList[i]}"]= {
                            job3 = build job: '/FO.CSA/JOB/WebApp.Deploy', propagate: false, parameters: [string(name: 'artifact_version', value: artifact_version), [$class: 'LabelParameterValue', name: 'node_to_run', label:nodeList[i]]]
    ...
    post {
            success{
                ...
                script{
                    ...
                    pipelineData['pipeline_ExpectedTime'] = 80
            ...
            failure {
                ...
                script{
                    ...
                    pipelineData['result'] = currentBuild.result
                    pipelineData['environment'] = envir
                    pipelineData['pipeline_ExpectedTime'] = 100
