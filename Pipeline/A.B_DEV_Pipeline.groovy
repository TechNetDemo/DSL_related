            ...
            steps{
                script{
                    try{
                        ...
                        build job: '/A.B/DEV/A.B_DEV_WebApp.Pipeline', parameters: [string(name: 'artifact_version', value: artifact_version),string(name: 'db_username', value: db_username),password(name: 'db_password', value: db_password)]
